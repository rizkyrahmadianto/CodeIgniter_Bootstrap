  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="<?php echo base_url(); ?>example/login">Logout</a>
      </div>
    </div>
  </div>
</div>
...
<!-- Page level plugins -->
<script src="<?php echo base_url(); ?>back-assets/vendor/chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?php echo base_url(); ?>back-assets/js/demo/chart-area-demo.js"></script>
<script src="<?php echo base_url(); ?>back-assets/js/demo/chart-pie-demo.js"></script>
